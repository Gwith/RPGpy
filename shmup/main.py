...
class Mob(pygame.sprite.Sprite):
    def __init__(self):
        ...
        #pygame.draw.circle(self.image, RED, self.rect.center, self.radius)
        self.rect.x = random.randrange(0, WIDTH - self.rect.width) #450
...
shoot_sound = pygame.mixer.Sound(path.join(snd_dir, 'Laser_Shoot4.wav'))
...
while running:
    ...
    hits = pygame.sprite.spritecollide(player, mobs, True, pygame.sprite.collide_circle) # False = if you collide mob gets deleted
    for hit in hits:
